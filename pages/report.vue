    ...
    <div class="w-full p-10 py-4">
      ...
      <div class="flex justify-between pt-6">
        <div date-rangepicker class="flex items-center">
          <div class="relative">
            <input type="date" name="start" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700" placeholder="Select date start">
          </div>
      ...
      <table class="w-full text-left text-gray-500 dark:text-gray-400 mt-4">
        ...
        >
          <tr>
            ...
            <th scope="col" class="px-6 py-3">CO2 Emission</th>
        ...
        <tbody>
          <tr v-for="shipment, index in shipments" :key='index' :class="{'bg-gray-100': index % 2 === 1, '': index % 2 === 0}" class="text-sm bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td class="px-6 py-3 font-medium text-gray-900 dark:text-white whitespace-nowrap">{{shipment.item_id}}</td>
            <td class="px-6 py-3">{{shipment.item_id}}</td>
            ...
            <td class="px-6 py-3">{{shipment.total_weight}}</td>
            <td class="px-6 py-3">
